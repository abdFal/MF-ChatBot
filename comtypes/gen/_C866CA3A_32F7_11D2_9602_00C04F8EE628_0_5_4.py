...
__all__ = [
    'SVSFIsFilename', 'DISPID_SAFType', 'SGRSTTDictation',
    'DISPID_SGRName', 'DISPID_SVSLastBookmark',
    'DISPID_SRSCurrentStreamNumber', 'SSTTTextBuffer', 'SGRSTTRule',
    'SRCS_Disabled', 'SAFT44kHz16BitMono', 'SDTProperty',
    'DISPID_SpeechPhraseRule', 'ISpShortcut', 'SECFEmulateResult',
    'SVP_10', 'IInternetSecurityManager', 'DISPID_SRSAudioStatus',
    'SpeechCategoryAudioIn', 'DISPID_SPIEnginePrivateData',
    'DISPID_SAFGuid', 'DISPID_SVPriority', 'IEnumString',
    ...
    'DISPID_SPRText', 'DISPID_SpeechLexiconWords',
    'DISPID_SVSInputWordLength', 'DISPID_SVSLastBookmarkId',
    'SDA_Consume_Leading_Spaces', 'SP_VISEME_16',
    ...
    'ISequentialStream', 'DISPID_SPIProperties', 'SpeechRuleState',
    'eLEXTYPE_PRIVATE11', 'DISPID_SMSADeviceId', 'SPEI_RECOGNITION',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SVPause',
    'SVSFParseSsml', 'SGDSActiveWithAutoPause', 'SpInprocRecognizer',
    'DISPID_SLAddPronunciation', 'SPXRO_SML',
    'DISPID_SRSSupportedLanguages', 'DISPID_SWFEAvgBytesPerSec',
    'SP_VISEME_3', 'SpeechEmulationCompareFlags',
    'DISPID_SOTGetDescription', 'SPRECORESULTTIMES',
    'DISPID_SGRAddResource', 'SVPAlert', 'SSFMOpenReadWrite',
    'SPSHORTCUTPAIRLIST', 'DISPID_SpeechObjectToken',
    'SAFT12kHz8BitMono', 'SpTextSelectionInformation',
    'SVEWordBoundary', 'SPRECOCONTEXTSTATUS', 'DISPID_SOTDisplayUI',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRCRecognizer',
    'DISPID_SpeechGrammarRule', 'SGSEnabled', 'ISpeechRecoResult',
    'SGDSInactive', 'SPGS_ENABLED', 'SpeechRecognitionType',
    'SPSInterjection', 'SRSActiveAlways', 'SSSPTRelativeToStart',
    'DISPID_SASCurrentDevicePosition',
    'DISPID_SpeechPhraseReplacements', 'SpCustomStream',
    'DISPID_SPRuleChildren', 'SPCONTEXTSTATE', 'ISpeechObjectToken',
    'DISPID_SRSetPropertyString', 'SPSUnknown', 'SITooFast',
    'DISPID_SRGetRecognizers', 'DISPID_SRSClsidEngine',
    'SPEI_START_SR_STREAM', 'SECFIgnoreCase',
    'tagSPTEXTSELECTIONINFO', 'SpeechInterference',
    'SGPronounciation', 'SAFTText', 'DISPID_SDKOpenKey',
    'ISpeechPhraseAlternates', 'SpeechBookmarkOptions',
    'SVSFIsNotXML', 'SAFT11kHz8BitStereo', 'SAFT11kHz16BitMono',
    'SPSHORTCUTTYPE', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechCategoryAppLexicons', 'DISPID_SRStatus', 'SP_VISEME_18',
    ...
    'SpeechVisemeFeature', 'DISPID_SRGRules', 'SP_VISEME_1',
    'DISPID_SpeechPhraseBuilder', 'SpFileStream', 'SRERecognition',
    'DISPID_SMSGetData', 'DISPID_SGRsDynamic', 'DISPID_SOTCategory',
    'SpeechVoicePriority', 'DISPID_SVWaitUntilDone',
    'SAFTADPCM_22kHzMono', 'SREHypothesis', 'SPFM_CREATE_ALWAYS',
    'SPRST_ACTIVE_ALWAYS', 'SpeechRegistryUserRoot',
    'SpeechMicTraining', 'DISPID_SDKGetBinaryValue', 'SBOPause',
    'SPGRAMMARSTATE', 'SPVISEMES', 'SRAExport', 'ISpObjectWithToken',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SpeechDataKey', 'SpMMAudioIn',
    'DISPID_SRCEAdaptation', 'SPINTERFERENCE_NOISE',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpeechEngineConfidence',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVStatus', 'SPPS_LMA',
    'SPINTERFERENCE_NOSIGNAL', 'SAFT8kHz8BitMono',
    'SAFTADPCM_44kHzStereo', 'ISpGrammarBuilder', 'SVP_20',
    'ISpeechPhraseProperties', 'ISpRecoGrammar2',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SVSVisemeId',
    'SPPS_Noun', 'ISpeechGrammarRules', 'eLEXTYPE_PRIVATE13',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SDKSetStringValue',
    'SpeechRecoEvents', 'DISPID_SPEActualConfidence',
    'DISPID_SPERequiredConfidence', 'SPEI_UNDEFINED', 'SP_VISEME_12',
    'DISPID_SRCEEndStream', 'DISPID_SRCERecognizerStateChange',
    'SPBO_NONE', 'SpeechVoiceEvents', 'SPWAVEFORMATTYPE',
    'SpCompressedLexicon', 'SAFT22kHz16BitStereo',
    ...
    'SAFT16kHz8BitStereo', 'DISPID_SLPType', 'SPSFunction',
    'SRESoundStart', 'DISPID_SVEAudioLevel', 'ISpNotifySink',
    'DISPID_SPAStartElementInResult', 'DISPID_SVSRunningState',
    'DISPID_SPRuleParent', 'SRERequestUI', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SVGetAudioInputs', 'DISPID_SAVolume',
    'DISPID_SRDisplayUI', 'SVF_Stressed', 'SpeechTokenIdUserLexicon',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRRTStreamTime', 'SPINTERFERENCE',
    'DISPID_SLPPhoneIds', 'SpShortcut', 'SPAR_Low', 'STSF_AppData',
    'eLEXTYPE_PRIVATE18', '_ISpeechVoiceEvents', 'ISpPhrase',
    'eLEXTYPE_PRIVATE5', 'DISPID_SVEStreamStart',
    'SPDKL_CurrentConfig', 'DISPID_SpeechPhraseElement',
    'DISPID_SOTDataKey', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRCEInterference', 'SPXRO_Alternates_SML',
    'SSSPTRelativeToEnd', 'DISPID_SpeechGrammarRules',
    'DISPID_SRProfile', 'DISPID_SVAudioOutput',
    'DISPID_SABIEventBias', 'DISPID_SVSyncronousSpeakTimeout',
    'SLOStatic', 'DISPID_SLWsCount', 'SVP_0', 'SPAR_Medium',
    'SPAR_High', 'SPSLMA', 'SPAS_PAUSE',
    'DISPID_SpeechPhraseElements', 'DISPID_SVSLastStreamNumberQueued',
    'SPAS_STOP', 'SpeechCategoryVoices',
    'DISPID_SpeechRecoContextEvents', 'SVP_14', 'DISPID_SPAs_NewEnum',
    'SAFT22kHz8BitStereo', 'DISPID_SRGState', 'ISpeechRecognizer',
    'SGDisplay', 'ISpeechLexiconWord', 'eWORDTYPE_DELETED',
    'DISPIDSPTSI_ActiveLength',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SDKLLocalMachine',
    'tagSPPROPERTYINFO', 'ISpNotifyTranslator', 'SPAS_CLOSED',
    'DISPID_SPANumberOfElementsInResult', 'SSFMCreateForWrite',
    'Speech_Max_Pron_Length', 'DISPIDSPTSI_ActiveOffset',
    'SPPS_Modifier', 'SRCS_Enabled', 'SPCT_COMMAND',
    'DISPID_SLPPartOfSpeech', 'SpeechAudioProperties',
    'ISpeechAudioStatus', 'SAFT48kHz8BitStereo',
    'SpeechDisplayAttributes', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPPFirstElement', 'DISPID_SLWType', 'SBONone',
    'ISpeechGrammarRuleState', 'DISPID_SRAudioInput', 'SASClosed',
    'SP_VISEME_4', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRGCmdLoadFromObject', 'SVP_4', 'ISpeechPhoneConverter',
    'DISPID_SPRuleId', 'DISPID_SPIEngineId', 'SPSEMANTICERRORINFO',
    'STCInprocHandler', 'DISPID_SGRId', 'SpeechSpecialTransitionType',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRCPause',
    'DISPID_SVGetProfiles', 'SpSharedRecoContext', 'SPPS_RESERVED1',
    'IEnumSpObjectTokens', 'DISPID_SPRFirstElement', 'ISpDataKey',
    'SpWaveFormatEx', 'SpeechAddRemoveWord', 'DISPID_SPILanguageId',
    'SVF_Emphasis', 'ISpLexicon', 'DISPID_SOTGetAttribute',
    'SAFT24kHz16BitMono', 'DISPID_SRGIsPronounceable',
    ...
    'DISPID_SPERetainedSizeBytes', 'UINT_PTR',
    'SpeechCategoryRecoProfiles', 'SFTSREngine',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpEventSink',
    'SRAORetainAudio', 'SpeechAudioState', 'DISPID_SASNonBlockingIO',
    'DISPID_SPPNumberOfElements', 'ISpeechBaseStream', 'SP_VISEME_17',
    'SVEPhoneme', 'DISPID_SRCBookmark', 'SVP_18', 'SpeechLoadOption',
    'SPTEXTSELECTIONINFO', 'DISPID_SPISaveToMemory',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SLGetWords',
    'ISpObjectTokenCategory', 'DISPID_SGRAttributes',
    'eLEXTYPE_RESERVED7', 'SP_VISEME_11', 'ISpeechAudioBufferInfo',
    'SREInterference', 'SPDKL_CurrentUser', 'DISPID_SPEAudioSizeTime',
    'SECNormalConfidence', 'SPPS_Interjection',
    'DISPID_SGRSTPropertyName', 'ISpAudio',
    'DISPID_SGRSAddWordTransition', 'SREStateChange',
    'DISPID_SOTCGetDataKey', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPRules_NewEnum', 'DISPID_SRGId', 'LONG_PTR',
    'ISpRecoContext', 'ISpStreamFormat', 'SVP_5',
    'DISPID_SRCEventInterests', 'ISpeechObjectTokenCategory',
    'ISpeechPhraseProperty', 'DISPID_SPCPhoneToId', 'SPEI_RESERVED2',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPRs_NewEnum',
    'DISPIDSPTSI_SelectionOffset', 'SP_VISEME_6',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRRecognizer',
    'SAFTGSM610_11kHzMono', 'SPEI_END_SR_STREAM', 'DISPID_SRRTLength',
    'SRSEDone', 'DISPID_SGRsCommitAndSave', 'SRTEmulated', 'SPRULE',
    'SpAudioFormat', 'DISPID_SGRsItem', 'ISpeechLexicon', 'SVP_8',
    'SGLexical', 'SPEI_PHRASE_START', 'SPCT_SLEEP',
    '_ISpeechRecoContextEvents', 'SpeechTokenValueCLSID',
    'ISpeechVoiceStatus', 'DISPID_SVSpeakCompleteEvent',
    'SpeechFormatType', 'SPRULESTATE', 'WAVEFORMATEX',
    'SPCATEGORYTYPE', 'SAFT48kHz8BitMono', 'SVEBookmark',
    'DISPID_SpeechAudioBufferInfo', 'SRSInactive',
    'DISPID_SVEStreamEnd', 'SASRun', 'SpeechRunState',
    'SAFTCCITT_ALaw_11kHzStereo', 'SVSFParseSapi',
    'SpeechDiscardType', 'DISPID_SpeechLexiconPronunciation',
    'SPEI_FALSE_RECOGNITION', 'SAFT24kHz8BitMono', 'SVP_3',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRGSetTextSelection',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SMSALineId', 'SVSFlagsAsync',
    'eLEXTYPE_PRIVATE17', 'SREAdaptation', 'SpeechStreamFileMode',
    'SpeechAllElements', 'SVP_13', 'DISPID_SpeechVoiceStatus',
    'ISpeechRecoResult2', 'SPWT_LEXICAL', 'SAFT22kHz16BitMono',
    'ISpeechDataKey', 'ISpRecognizer', 'SPPHRASERULE',
    'DISPID_SBSSeek', 'DISPID_SpeechMemoryStream',
    'ISpPhoneConverter', 'DISPID_SRGDictationLoad', 'DISPID_SPEsItem',
    'SDTDisplayText', 'STCRemoteServer', 'SP_VISEME_0',
    'SDA_No_Trailing_Space', 'SPPS_RESERVED2', 'ISpeechGrammarRule',
    'ISpRecognizer3', 'DISPID_SRCVoice', 'SVEViseme',
    'SAFTADPCM_44kHzMono', 'ISpeechLexiconPronunciation',
    'ISpeechRecoGrammar', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'ISpeechResourceLoader', 'SVSFIsXML', 'eLEXTYPE_PRIVATE10',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPEDisplayAttributes',
    'SDTRule', 'DISPID_SVSpeakStream', 'SPRS_ACTIVE',
    'SpeechAudioFormatType', 'DISPID_SPEEngineConfidence',
    'eLEXTYPE_PRIVATE2', 'DISPID_SpeechWaveFormatEx',
    'SECFIgnoreWidth', 'ISpeechObjectTokens',
    'SPWORDPRONUNCIATIONLIST', 'SASPause', 'DISPID_SOTCSetId',
    'DISPID_SLWPronunciations', 'SPPS_Function',
    'DISPID_SRAudioInputStream', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SPRuleNumberOfElements',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SpeechMMSysAudio',
    'DISPID_SADefaultFormat', 'Speech_Max_Word_Length',
    'STCLocalServer', 'DISPID_SFSClose', 'SASStop',
    'DISPID_SPRNumberOfElements', 'SDA_One_Trailing_Space',
    'SPRST_INACTIVE', 'SRAImport', 'SAFTExtendedAudioFormat',
    'ISpeechTextSelectionInformation', 'SPEI_SR_PRIVATE',
    'DISPID_SGRSTsItem', 'SAFTCCITT_ALaw_22kHzStereo', 'SPEI_MIN_SR',
    'SpUnCompressedLexicon', 'DISPID_SOTIsUISupported', 'SINoise',
    'SPRST_ACTIVE', 'SpInProcRecoContext',
    'DISPID_SpeechLexiconProns', 'SPSERIALIZEDRESULT',
    'SPRECOGNIZERSTATUS', 'SpeechTokenContext', 'SpeechPartOfSpeech',
    'DISPID_SDKCreateKey', 'SpeechCategoryPhoneConverters',
    'DISPID_SDKSetLongValue', 'DISPID_SPRuleFirstElement',
    'SPLOADOPTIONS', 'SPADAPTATIONRELEVANCE', 'ISpeechCustomStream',
    'SGSDisabled', 'SVESentenceBoundary', 'ISpeechPhraseRules',
    'SPVPRIORITY', 'SRTAutopause', 'SVP_21',
    'DISPID_SpeechRecoContext', 'SVPOver', 'SpeechGrammarTagWildcard',
    'SPSHORTCUTPAIR', 'SDTReplacement', 'SpeechTokenKeyUI',
    'SPEI_HYPOTHESIS', 'SpeechPropertyResponseSpeed',
    'DISPID_SpeechCustomStream', 'DISPID_SpeechObjectTokenCategory',
    'ISpSerializeState', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPIGetDisplayAttributes', 'SPINTERFERENCE_NONE',
    'DISPID_SPPBRestorePhraseFromMemory', 'SREFalseRecognition',
    'DISPID_SOTsItem', 'SAFT11kHz16BitStereo', 'DISPID_SOTsCount',
    'SVP_6', 'SpeechVoiceCategoryTTSRate', 'SAFTCCITT_ALaw_8kHzMono',
    'SpeechAudioVolume', 'ISpPhraseAlt', 'DISPID_SGRsCount',
    'DISPID_SRRAudioFormat', 'SGRSTTWord',
    'DISPID_SpeechPhraseReplacement', 'SPLEXICONTYPE',
    'SpeechVisemeType', 'DISPID_SGRsFindRule', 'STCInprocServer',
    'SAFTADPCM_8kHzStereo', 'SPWT_PRONUNCIATION', 'SITooLoud',
    'DISPID_SMSAMMHandle', 'DISPID_SGRs_NewEnum', 'SpStream',
    'DISPID_SVSkip', 'eLEXTYPE_PRIVATE12', 'SPPS_SuppressWord',
    'DISPID_SpeechLexicon', 'DISPID_SCSBaseStream',
    'SAFT12kHz16BitStereo', 'DISPID_SVGetVoices',
    'ISpeechRecoResultDispatch', 'SPEI_SR_BOOKMARK',
    'ISpeechRecoContext', 'SPSHT_Unknown', 'eLEXTYPE_USER_SHORTCUT',
    'SVSFDefault', 'DISPID_SPPId', 'SPRS_INACTIVE', 'SGDSActive',
    'SpeechCategoryAudioOut', 'SPWORDPRONUNCIATION',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SOTSetId', 'SPPS_Unknown',
    'DISPID_SVVoice', 'DISPID_SLPsItem', 'SPCT_DICTATION',
    'STSF_CommonAppData', 'SPEVENTSOURCEINFO', 'DISPID_SPAsItem',
    'DISPID_SRCCreateGrammar', 'SPEI_RESERVED5', 'DISPID_SOTRemove',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SpeechVoice',
    'SITooSlow', 'SPEI_VISEME', 'DISPID_SRGDictationSetState',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechRecoResult2',
    'SECHighConfidence', 'DISPID_SPRuleConfidence',
    'SRTExtendableParse', 'SPEI_INTERFERENCE', 'SPEI_MAX_SR',
    'Speech_StreamPos_Asap', 'DISPID_SPPs_NewEnum', 'tagSTATSTG',
    'SDTLexicalForm', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRRSpeakAudio', 'SWPUnknownWordPronounceable',
    'DISPID_SPIRule', 'DISPID_SPEAudioStreamOffset', 'SPBO_AHEAD',
    'DISPID_SPACommit', 'DISPID_SRGetFormat',
    'DISPID_SpeechRecognizer', 'SpeechUserTraining', 'SpLexicon',
    'SPPS_Verb', 'DISPID_SpeechAudioFormat', 'SVSFVoiceMask',
    'DISPID_SRCEHypothesis', 'SPEVENTENUM',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_RESERVED6',
    'SAFTADPCM_8kHzMono', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRRTOffsetFromStart', 'SPLO_DYNAMIC',
    'SSSPTRelativeToCurrentPosition', 'SPEI_PHONEME', 'SP_VISEME_10',
    'SpeechCategoryRecognizers', 'SINoSignal', 'SPEI_RESERVED6',
    'SPINTERFERENCE_TOOSLOW', 'SAFTCCITT_ALaw_11kHzMono', 'SRSActive',
    'eLEXTYPE_PRIVATE3', 'SWPKnownWordPronounceable',
    'DISPID_SPRulesCount', 'DISPID_SGRSTText', 'SpMMAudioEnum',
    'DISPID_SPPChildren', 'SPPS_RESERVED4',
    'DISPID_SPPEngineConfidence', 'DISPID_SpeechPhraseRules',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SLWs_NewEnum',
    'ISpeechPhraseReplacement', 'SVP_17', 'SpeechAudioFormatGUIDWave',
    'SSFMCreate', 'SRARoot', 'DISPID_SOTMatchesAttributes',
    'DISPID_SPIAudioSizeBytes', 'eLEXTYPE_PRIVATE15', 'SINone',
    'DISPID_SVESentenceBoundary', 'SSFMOpenForRead',
    'DISPID_SABufferInfo', 'DISPID_SGRSTsCount', 'DISPID_SLWWord',
    'DISPID_SRGCommit', 'SPDKL_LocalMachine',
    'DISPID_SREmulateRecognition', 'SPGRAMMARWORDTYPE',
    'DISPID_SPRuleName', 'DISPID_SVAudioOutputStream',
    'SDKLCurrentUser', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPPARTOFSPEECH',
    'DISPID_SRRGetXMLResult', 'SSTTDictation', 'ISpMMSysAudio',
    'DISPID_SpeechGrammarRuleState', 'ISpeechPhraseRule',
    'SP_VISEME_21', 'DISPID_SOTRemoveStorageFileName',
    'ISpResourceManager', 'SDKLDefaultLocation', 'SP_VISEME_15',
    'DISPID_SRCESoundEnd', 'ISpeechPhraseInfo', 'DISPID_SRRTimes',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SDKDeleteValue',
    'SpPhoneticAlphabetConverter', 'SPEI_SOUND_START', 'SGSExclusive',
    'ISpeechPhraseElement', 'SPEI_RESERVED1', 'SPFM_NUM_MODES',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFTCCITT_uLaw_22kHzStereo',
    'SpeechRegistryLocalMachineRoot', 'SRATopLevel',
    'ISpeechRecognizerStatus', 'SpeechAudioFormatGUIDText',
    'SPEI_START_INPUT_STREAM', 'SPEI_ADAPTATION', 'DISPID_SPRsCount',
    'DISPID_SRRAlternates', 'ISpeechPhraseElements',
    'SAFT44kHz8BitStereo', 'SVP_11', 'SRESoundEnd', '_SPAUDIOSTATE',
    'SPEI_WORD_BOUNDARY', 'DISPID_SRRPhraseInfo',
    'SAFTADPCM_11kHzMono', 'DISPID_SRCCmdMaxAlternates',
    'SP_VISEME_5', 'DISPID_SRCRequestedUIType', 'SpMMAudioOut',
    'SAFT44kHz16BitStereo', 'SAFT48kHz16BitStereo',
    'DISPID_SDKDeleteKey', 'DISPID_SGRsAdd', 'SPSEMANTICFORMAT',
    'SREPropertyStringChange', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SVIsUISupported', 'DISPID_SRCEPropertyNumberChange',
    'SPSERIALIZEDPHRASE', 'SPAO_RETAIN_AUDIO', 'SPEI_SR_AUDIO_LEVEL',
    'SPBO_TIME_UNITS', 'ISpeechWaveFormatEx',
    'DISPID_SRGCmdLoadFromMemory', 'eLEXTYPE_RESERVED10',
    'SRADynamic', 'SpObjectTokenCategory',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT24kHz8BitStereo', 'DISPID_SRRGetXMLErrorInfo',
    'SPAUDIOSTATE', 'eLEXTYPE_RESERVED4', 'SITooQuiet',
    'SAFT22kHz8BitMono', 'SREBookmark', 'SPPHRASEELEMENT',
    'SpeechRecoProfileProperties', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SVEPhoneme', 'SpNotifyTranslator', 'SpResourceManager',
    '_RemotableHandle', 'SVEVoiceChange', 'ISpRecoCategory',
    'SAFT16kHz16BitStereo', 'eLEXTYPE_USER', 'DISPID_SRCERequestUI',
    'SECLowConfidence', 'STCAll', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SDTPronunciation', 'SPSModifier', 'SVEAudioLevel',
    'SPGS_EXCLUSIVE', 'SPEI_MAX_TTS', 'DISPID_SLPsCount',
    'SpeechGrammarTagDictation', 'DISPID_SOTs_NewEnum',
    'SPPROPERTYINFO', 'DISPID_SOTCId', 'SRADefaultToActive',
    'SPVOICESTATUS', 'DISPID_SPAPhraseInfo', 'DISPID_SOTId',
    'DISPID_SpeechPhraseProperties', 'DISPID_SGRSRule',
    'SGRSTTEpsilon', 'SRAONone', 'SPGS_DISABLED', 'SPEVENT',
    'DISPID_SPIElements', 'SPFILEMODE', 'SPBOOKMARKOPTIONS',
    'SPSMF_UPS', 'SGRSTTWildcard', 'SPAUDIOBUFFERINFO',
    'ISpeechGrammarRuleStateTransition', 'SPPS_RESERVED3', 'SPSVerb',
    'SPWF_INPUT', 'DISPID_SpeechVoiceEvent',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SVRate',
    'DISPID_SVEEnginePrivate', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SGRsCommit', 'IStream', 'SVSFParseMask',
    'SpeechTokenKeyFiles', 'SAFTNonStandardFormat', 'SPBO_PAUSE',
    'Speech_Default_Weight', 'eLEXTYPE_MORPHOLOGY', 'SVEPrivate',
    'SWTAdded', 'SVP_1', 'SVP_9', 'SPAUDIOSTATUS',
    '__MIDL_IWinTypes_0009', 'ISpVoice', 'DISPID_SGRSTRule',
    'SRSEIsSpeaking', 'SpStreamFormatConverter', 'DISPID_SRRAudio',
    'SpVoice', 'SAFT12kHz8BitStereo', 'SpeechLexiconType',
    'DISPID_SLGenerationId', 'SP_VISEME_7', 'ISpNotifySource',
    'STSF_FlagCreate', 'ISpPhoneticAlphabetConverter',
    'SpeechEngineProperties', 'SPDKL_DefaultLocation', 'SLTUser',
    'DISPID_SRRTTickCount', 'SREAudioLevel', 'SP_VISEME_9',
    'SAFTNoAssignedFormat', 'SAFT44kHz8BitMono',
    'SAFT8kHz16BitStereo', 'SpeechGrammarWordType',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechStreamSeekPositionType',
    'SECFDefault', 'SPWORDTYPE', 'SVP_15', 'SPSTREAMFORMATTYPE',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRCERecognition',
    'SVP_12', 'SpeechPropertyNormalConfidenceThreshold',
    'SDTAlternates', 'DISPID_SGRSTransitions', 'SPEI_MIN_TTS',
    'SpeechVoiceSkipTypeSentence',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVSFUnusedFlags',
    'SPWORDLIST', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SASetState', 'SpeechVoiceSpeakFlags', 'DISPID_SPPValue',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechFileStream',
    'ISpRecognizer2', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'eLEXTYPE_RESERVED9', 'SAFT11kHz8BitMono',
    'DISPID_SOTCreateInstance', 'DISPID_SDKGetlongValue',
    'DISPID_SRCEAudioLevel', 'SpeechRecognizerState',
    'DISPID_SVSInputSentenceLength', 'ISpRecoContext2',
    'DISPID_SFSOpen', 'DISPID_SPPConfidence',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPEI_SR_RETAINEDAUDIO',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SREPropertyNumChange',
    'DISPID_SpeechPhraseInfo', 'DISPID_SBSWrite', 'SREAllEvents',
    'eLEXTYPE_PRIVATE1', 'DISPID_SBSFormat', 'SPWF_SRENGINE',
    'SpeechTokenKeyAttributes', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SASState', 'DISPID_SRGetPropertyNumber',
    'DISPID_SpeechObjectTokens', 'DISPID_SPRuleEngineConfidence',
    'SpeechWordPronounceable', 'SPSHT_EMAIL',
    'DISPID_SRCEPhraseStart', 'DISPID_SGRSTWeight',
    'SGLexicalNoSpecialChars', 'SPEI_REQUEST_UI', 'SDTAudio',
    'DISPID_SRCreateRecoContext', 'SECFNoSpecialChars',
    'SAFT12kHz16BitMono', 'SPPHRASE', 'SLTApp', 'SPLO_STATIC',
    ...
    'SpeechRetainedAudioOptions', 'SpPhoneConverter',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpEventSource',
    'eLEXTYPE_VENDORLEXICON', 'SDKLCurrentConfig',
    'DISPID_SRCSetAdaptationData', 'SPWT_DISPLAY',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRState',
    'DISPID_SVSInputWordPosition', 'DISPID_SPEDisplayText',
    'SpeechTokenShellFolder', 'SDTAll', 'DISPID_SVEBookmark',
    'SpObjectToken', 'DISPID_SpeechXMLRecoResult',
    'SRERecoOtherContext', 'ISpeechFileStream', 'SAFT32kHz8BitStereo',
    'ISpeechMemoryStream', 'DISPID_SVSLastResult', 'SPRECOSTATE',
    'eLEXTYPE_PRIVATE20', 'DISPID_SpeechAudioStatus',
    'DISPID_SLPs_NewEnum', 'SVP_2', 'DISPID_SRGetPropertyString',
    'DISPID_SVResume', 'SRTReSent', 'DISPID_SPCLangId',
    'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPPS_Noncontent', 'SP_VISEME_2', 'ISpProperties',
    'SPAUDIOOPTIONS', 'eLEXTYPE_PRIVATE19', 'SPSHT_NotOverriden',
    'DISPID_SGRAddState', 'SPEI_SOUND_END',
    'DISPID_SABufferNotifySize', 'DISPID_SOTCDefault',
    'DISPID_SLWsItem', 'SRSInactiveWithPurge', 'DISPID_SVSPhonemeId',
    'eLEXTYPE_APP', 'SPCT_SUB_COMMAND', 'DISPID_SRRSaveToMemory',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SDKSetBinaryValue',
    'DISPID_SLWLangId', 'DISPID_SRSNumberOfActiveRules',
    'ISpeechPhraseAlternate', 'SPEI_VOICE_CHANGE',
    'DISPID_SAFGetWaveFormatEx', 'STSF_LocalAppData', 'SVP_19',
    'IInternetSecurityMgrSite', 'SAFT32kHz16BitMono',
    'DISPID_SPIGrammarId', 'ISpeechRecoResultTimes',
    'SAFT24kHz16BitStereo', 'DISPID_SPARecoResult',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVEWord',
    'SAFTGSM610_22kHzMono', 'SPXMLRESULTOPTIONS', 'SAFT8kHz16BitMono',
    'SWTDeleted', 'SAFTGSM610_44kHzMono',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRRRecoContext',
    'SVP_16', 'SPDATAKEYLOCATION', 'DISPID_SLRemovePronunciation',
    'SpeechPropertyResourceUsage', 'DISPID_SWFEChannels',
    'DISPIDSPRG', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SABIBufferSize',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SP_VISEME_13',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechPropertyAdaptationOn',
    'DISPID_SPIAudioSizeTime', 'SPCS_DISABLED', 'DISPID_SVSpeak',
    'SVP_7', 'DISPID_SPPName', 'DISPID_SGRInitialState',
    'DISPID_SRCState', 'SpNullPhoneConverter',
    'DISPID_SGRSTPropertyId', 'SGRSTTTextBuffer', 'SPPHRASEPROPERTY',
    'DISPID_SRCEBookmark', 'SPFM_OPEN_READONLY',
    'ISpeechXMLRecoResult', 'SP_VISEME_20', 'DISPID_SPEs_NewEnum',
    'SPBINARYGRAMMAR', 'ISpXMLRecoResult', 'SREStreamEnd',
    'eLEXTYPE_RESERVED8', 'ISpeechLexiconWords', 'SPSNotOverriden',
    'DISPID_SLPLangId', 'SPVPRI_ALERT', 'DISPID_SpeechPhoneConverter',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechAudioFormat',
    'DISPID_SRCEStartStream', 'SVPNormal', 'SpMemoryStream',
    'SAFTADPCM_11kHzStereo', 'SPVPRI_NORMAL', 'SPCS_ENABLED',
    'SpSharedRecognizer', 'SP_VISEME_19', 'DISPID_SRCRetainedAudio',
    'DISPID_SPAsCount', 'eWORDTYPE_ADDED', 'SPSSuppressWord',
    'DISPID_SAEventHandle', 'DISPID_SPPParent',
    'DISPID_SPELexicalForm', 'DISPID_SVDisplayUI',
    'DISPID_SGRSTNextState', 'SRTStandard', 'SVEStartInputStream',
    'DISPID_SGRSTPropertyValue', 'ISpStream', 'SREPrivate',
    'DISPID_SPCIdToPhone', 'DISPID_SPPsCount', 'DISPID_SPPsItem',
    'DISPID_SVEventInterests', 'eLEXTYPE_PRIVATE14', 'SRAInterpreter',
    'DISPID_SOTGetStorageFileName', 'DISPIDSPTSI',
    ...
    'SPRST_NUM_STATES', 'DISPID_SRGRecoContext', 'eLEXTYPE_PRIVATE7',
    'SVSFParseAutodetect', 'SPSHT_OTHER', 'SPEI_SENTENCE_BOUNDARY',
    'eLEXTYPE_PRIVATE16', 'DISPID_SVVolume', 'SAFT48kHz16BitMono',
    'eLEXTYPE_PRIVATE6', 'SpeechRecoContextState',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SGRClear', 'SFTInput',
    'DISPID_SRGReset', 'SRTSMLTimeout', 'DISPID_SVAlertBoundary',
    'SPAO_NONE', 'ISpeechLexiconPronunciations', 'DISPID_SRCResume',
    'DISPID_SAFSetWaveFormatEx', 'ISpRecoGrammar',
    'SAFT16kHz8BitMono', 'DISPID_SLPSymbolic',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SPIReplacements',
    'DISPID_SRGCmdLoadFromFile', 'SECFIgnoreKanaType', 'ISpeechVoice',
    'SPSNoun', 'SPFM_OPEN_READWRITE', 'SP_VISEME_14',
    'SpeechWordType', 'SPFM_CREATE', 'SAFT8kHz8BitStereo',
    'SPVPRI_OVER', 'DISPID_SPIStartTime', 'DISPID_SPIGetText',
    'DISPID_SLGetPronunciations', 'DISPID_SpeechAudio',
    'ISpStreamFormatConverter', 'SPWORDPRONOUNCEABLE', 'SLODynamic',
    'ISpeechPhraseReplacements', 'SAFT16kHz16BitMono',
    'DISPID_SRIsShared', 'DISPID_SpeechRecoResult',
    'SPPS_NotOverriden', 'DISPID_SMSSetData',
    'DISPID_SpeechLexiconWord', 'SVF_None', 'SPAS_RUN',
    'SAFTCCITT_uLaw_44kHzMono', 'SVSFNLPMask', 'DISPID_SVEViseme',
    'ISpeechAudio', 'SREPhraseStart', 'DISPID_SVEVoiceChange',
    'SVSFNLPSpeakPunc', 'SAFT32kHz16BitStereo',
    'DISPID_SRIsUISupported', 'DISPID_SAStatus', 'DISPID_SPRulesItem',
    'DISPID_SWFEBlockAlign', 'SPEI_TTS_BOOKMARK',
    'SDA_Two_Trailing_Spaces', 'SpeechRuleAttributes',
    'SpPhraseInfoBuilder',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SWFEExtraData', 'SPEI_TTS_PRIVATE', 'SAFT32kHz8BitMono',
    'ISpObjectToken', 'SSTTWildcard', 'SAFTGSM610_8kHzMono',
    'DISPID_SRCESoundStart', 'SAFTDefault',
    'DISPIDSPTSI_SelectionLength', 'SPWORD',
    'DISPID_SRCEFalseRecognition', 'SP_VISEME_8', 'SVSFPersistXML',
    'DISPID_SRGDictationUnload', 'SVEAllEvents',
    'DISPID_SASFreeBufferSpace', 'ISpeechMMSysAudio',
